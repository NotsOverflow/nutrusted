...
function startLevel(map) {
    ...
    map.placeObject(map.getWidth()-19, 3, 'block');
    map.placeObject(map.getWidth()-20, 2, 'block');
    map.placeObject(map.getWidth()-21, 2, 'block');
    map.placeObject(map.getWidth()-22, 2, 'block');
}
